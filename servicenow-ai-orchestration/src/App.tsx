...
import { DuplicateContractDetection } from './components/tables/DuplicateContractDetection';
...
function DuplicateDetectionPage() {
  return <DuplicateContractDetection />;
}
      ...
      <ToastProvider>
        <BrowserRouter>
          <Layout>
            ...
            <Route path="/tables/duplicate-detection" element={<DuplicateDetectionPage />} />
